...
public class AlternativeDateSlider extends DateSlider {
	 ...
	 */
	public AlternativeDateSlider(Context context, OnDateSetListener l, MutableDateTime calendar) {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mYearScroller.setLabeler(yearLabeler, mTime.getMillis(),180,60);
		...
		mMonthScroller.setLabeler(monthLabeler, mTime.getMillis(),150,60);
		...
		mDayScroller.setLabeler(dayLabeler, mTime.getMillis(),45,60);
