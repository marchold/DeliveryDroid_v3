...
public class MeterView extends LinearLayout implements MeterNumberPicker.OnValueChangedListener {
    ...
    private void populate(Context context) {
        for (int i = 0; i < numberOfFirst + numberOfSecond; i++) {
            ...
            meterNumberPicker.setOnValueChangedListener(this);
    ...
    public void setOnValueChangedListener(MeterNumberPicker.OnValueChangedListener onValueChangedListener) {
    ...
    private MeterNumberPicker.OnValueChangedListener onValueChangedListener;

    @Override
    public void onValueChanged(int value) {
        if (onValueChangedListener!=null) onValueChangedListener.onValueChanged(getValue());
    }
}
