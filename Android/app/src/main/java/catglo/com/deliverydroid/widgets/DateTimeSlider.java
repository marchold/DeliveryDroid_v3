...
public class DateTimeSlider extends DateSlider {
	...
	public DateTimeSlider(Context context, OnDateSetListener l,	MutableDateTime calendar) {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mMonthScroller.setLabeler(monthLabeler, mTime.getMillis(),180,60);
		...
		mDayScroller.setLabeler(dayLabeler, mTime.getMillis(),120,60);
		...
		mTimeScroller.setLabeler(timeLabeler, mTime.getMillis(),80,60);
	...
	protected void setTitle() {
		if (mTitleText != null) {
			//   .get(Calendar.MINUTE)
			int minute = mTime.getMinuteOfHour()/MINUTEINTERVAL*MINUTEINTERVAL;
